...
?>
<div class="row col-md-4 col-md-offset-4 my-5" >
  <?php
    if($ac==1)
    {
      echo '<form action="index1.php?action=hanghoa&act=insert_action" method="post">';
    }
    else
    {
      echo '<form action="index1.php?action=hanghoa&act=update_action" method="post">';
    }
  ?>
    ...
    <table class="table" style="border: 0px;">
      ...
      <tr>
        <td>Số lượt xem</td>
        <td><input type="text" class="form-control" value="<?php if(isset($slx)) echo $slx;?>" name="soluotxem" >
        </td>
      </tr>
      <tr>
        <td>Ngày lập</td>
