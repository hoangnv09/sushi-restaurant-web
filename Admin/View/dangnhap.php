<div class="login-page bk-img" style="background-image: url(/Content/images/img_slide02.jpg);">
					...
					<div class="col-md-6 col-md-offset-3">
						...
						<div class="well row pt-2x pb-3x bk-light">
							<div class="col-md-8 col-md-offset-2">
								<form method="post" action="index1.php?action=dangnhap&act=dangnhap_action" class="login-form">
