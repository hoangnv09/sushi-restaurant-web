...
<div class="container my-5">
  ...
  <div class="row border rounded-5 p-3 bg-white shadow box-area justify-content-center" style="width: 50%;margin: auto">
    <div class="col-xs-12 col-sm-12 col-md-12 well well-sm ">
      ...
      <form action="index.php?action=dangky&act=dangky_action" method="post" class="form" role="form">
        <div class="row">
          ...
          <div class="col-xs-8 col-md-8"><input class="form-control" name="txtuser" placeholder="Tên đăng nhập" required="" type="text">
          </div>
